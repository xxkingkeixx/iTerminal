...
#  flagging, avoiding flood bans, detecting flags, message bg in pm's, idling in pm's.
...
class PM(object):
	...
	def message(self, user, msg):
		...
		self._sendCommand("msg", user.name, "<n%s/><m v=\"1\"><g xs0=\"0\"><g x%ss%s=\"6\">%s</g></g></m>" % (self._mgr.user.nameColor.lower(), self._mgr.user.fontSize, self._mgr.user.fontColor.lower(), msg))
