...
<html lang="en">
    ...
    <body>
        ...
        <div class="widget-sidebar hidden-item">
            <!-- widget Tabs -->
            <div class="widget section-white around-white">
        ...
        <div id="success-contact" class="modal fade success-contact" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <header class='modal-header'>
                        <div class='message'>
                    ...
                    <section class='content around-white'>
                        <header class="text-center">
                            <h4 class="font-hard">Thank you For Feedback.</h4>
                            <hr>
        ...
        <section class="wrapper">
            <section class='section-black around-white'>
                <div class="body">
                    <header>
                        <h1 class='font-hard text-extra-big'>- <span class='text-color'>.</span></h1>
            ...
            <section class='section-dark around-white'>
                <div class="body">
                    <div class='row'>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 hover-text-title-color">
                            <div class='col-lg-2'>
                                <i class='glyphicon glyphicon-road text-large text-title'></i>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 hover-text-title-color">
                            <div class='col-lg-2'>
                                <i class='glyphicon glyphicon-phone text-large text-title'></i>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 hover-text-title-color">
                            <div class='col-lg-2'>
                                <i class='glyphicon glyphicon-envelope text-large text-title'></i>
                            </div>
                            <div class='col-lg-10'>
                                <h3 class="text-left left text-medium font-hard text-title">Email Address</h3>
                                <div class="clearfix"></div>
                                <p>
                                    OUR-ADMIN-EMAIL-HERE
                                </p>
                            </div>
                        </div>
            ...
            <section class='section'>
                <div class="body full">
                    <div class="bg-wrapper front"></div>
                    <div id="map" class="map"></div>
                    <div class="contact-form front">

                        <div class="wrapper-form bg-black around-white">
                            <h3 class="font-hard">CONTACT FORM</h3>
                            <hr>
                            <form id="contact" action="#" class="form-contact">
                                ...
                                <hr>
                                <input type="text" class="website form-control" placeholder="WEBSITE">
                                <hr>
